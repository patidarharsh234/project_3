		...
		<form action="<%=ORSView.MARKSHEET_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						type="submit" class="btn btn-light btn-md" style="font-size: 17px"
			...
			<div style="margin-bottom: 20px;" class="table-responsive">
				<table class="table table-info table-bordered table-hover">
					<thead>
						<tr class="text-center" style="background-color: #8C8C8C;">
					...
					while (it.hasNext()) {
						...
						int chm = dto.getChemistry();
						int mat = dto.getMaths();
						int phy = dto.getPhysics();
						int total = (chm + mat + phy);
					%>
