...
<style type="text/css">
.harsh {
	background-image: linear-gradient(to bottom left, #5c6bc0, black);
}
...
<body>
	...
	<!-- hedar kese lagaya / "navbar-brand" ye image ko responsive -->
	<div class="header">
...
<!-- minimize me button show ese ho ra-->
	...
	<!-- left side se hedar pr links ko show krna -->	
	<ul class="nav navbar-nav ml-auto">
       ...
       <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false">
		<font style="color: Black;"><%=welcomeMsg%> </font></a>
