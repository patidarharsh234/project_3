...
<style>
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/texxture.jpg');
	background-size: 100%;
}
       ...
       <div class="row">
				...
				<div class="col-md-4 alert alert-success alert-dismissible"
					 style="background-color: #80ff80">
					  ...
					  <h4><font color="#008000"><%=ServletUtility.getSuccessMessage(request)%></font>
					  </h4>
				</div>
...
<!-- ....getErrorMessage................................................. -->	
		...
		<div class="row">
				...
				<div class=" col-md-4 alert alert-danger alert-dismissible">
					 ...
					 <h4><font color="red"> <%=ServletUtility.getErrorMessage(request)%></font>
					 </h4>
				</div>
				<%
					}
...
<!--.TABLE................................................................ -->		
		...
		<div style="margin-bottom: 20px;" class="table-responsive">
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<thead><tr style="background-color: #8C8C8C;">
...
<!--_________>>>>>>___________________________________________________________________________________>>>>___________ -->

			<input type="hidden" name="pageNo" value="<%=pageNo%>"> 
			<input	type="hidden" name="pageSize" value="<%=pageSize%>">
		
<!--__________>>>>>____________________________________________________________________________________>>>>>__________ -->
    </form>
